...
<div id='downloads_item'>
    <h3><a href="{modurl modname="StrainID2" type="user" func="prepHandOut" lid=$item->getLid()}">{img modname='core' set='icons/large' src='download.png' __title='Download' __alt='Download' class='tooltips'}
...
{checkpermissionblock component='StrainID2::' instance='::' level=ACCESS_EDIT}
    <p id="downloads_item_editlink"><a href="{modurl modname='StrainID2' type='admin' func='edit' id=$item->getLid()}" title="{gt text='Edit this download'}">{gt text='Edit'}</a></p>
